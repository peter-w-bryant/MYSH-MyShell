...
### Redirection
To enable a shell user who prefers to send the output of a program to a file rather than to stdout, I have included the functionality to handle output redirection.
...
3. The original assignment specification was provided by instructors from CS537: Operating Systems taught at the University of Wisconsin-Madison in Spring 2022.
